...
```dotenv
CLOOP_PI_MODEL=zai/glm-5.2,kimi-coding/kimi-for-coding,openai-codex/gpt-5.5
CLOOP_PI_ORGANIZER_MODEL=zai/glm-5.2,kimi-coding/kimi-for-coding,openai-codex/gpt-5.5
...
The project preference order is `zai/glm-5.2`, then `kimi-coding/kimi-for-coding`, then
