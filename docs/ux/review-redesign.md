...
- The next roadmap slice should focus on post-action receipts, rollback cues, and resume breadcrumbs instead of reopening the shared review-shell structure.
