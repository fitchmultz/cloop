...
- POST /loops/{id}/comments: Add comment to loop
- GET /loops/{id}/comments: List comments for loop
- PATCH /loops/{id}/comments/{cid}: Update comment
- DELETE /loops/{id}/comments/{cid}: Soft-delete comment
...
# ... (existing content up to line 2613)


# ============================================================================
# Duplicate Detection and Merge Endpoints
# ============================================================================
