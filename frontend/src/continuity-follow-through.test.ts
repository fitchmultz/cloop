  ...
  it("ranks a recent receipt above an anchor-only fallback and suppresses a duplicate anchor target", () => {
    const anchors: ResumeAnchorState = {
      ...
      review: {
        ...
        workingSetId: 7,
        workflowThreadId: "review:enrichment:52",
        resolvedResume: null,
        degraded: false,
        degradedLabel: null,
      },
    ...
    const outcomes = readRankedLandedOutcomes({
      ...
      resumeAnchors: {
        planning: {
          ...
          resolvedResume: {
            requestedLocation: location({ state: "plan", reviewFocus: "planning", sessionId: 41 }),
            resolvedLocation: location({ state: "plan", reviewFocus: "planning", sessionId: 41 }),
            status: "ok",
            message: null,
            successor: {
              kind: "replacement",
              ...
              resolvedLocation: location({ state: "plan", reviewFocus: "planning", sessionId: 99 }),
              status: "ok",
              message: "Old plan was superseded by Replacement plan.",
            },
          },
          degraded: false,
          degradedLabel: null,
