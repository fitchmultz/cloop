...
export type LoopEnrichmentResponse = ApiTypes.LoopEnrichmentResponse;
export type LoopEnrichmentStatus = ApiTypes.LoopEnrichmentStatus;
...
export type MemoryMutationResponse = ApiTypes.MemoryMutationResponse;
export type MemoryDeleteResponse = ApiTypes.MemoryDeleteResponse;
