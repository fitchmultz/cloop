...
export type ContinuityAnchorResponse = ApiSchema<"ContinuityAnchorResponse">;
export type ContinuityAnchorUpsertRequest = ApiSchema<"ContinuityAnchorUpsertRequest">;
export type ContinuityAnchorsResponse = ApiSchema<"ContinuityAnchorsResponse">;
...
export type ContinuityThreadSummaryResponse = ApiSchema<"ContinuityThreadSummaryResponse">;
