...
export function buildShellElements(): ShellElements {
  return {
    ...
    stateButtons: Array.from(document.querySelectorAll<HTMLButtonElement>("[data-shell-state]:not([data-shell-mobile-work])")),
    mobileWorkButton: requireElement("shell-mobile-work-btn", HTMLButtonElement),
    ...
    workSubnav: requireElement("work-subnav", HTMLElement),
    workButtons: Array.from(document.querySelectorAll<HTMLButtonElement>("[data-work-state]")),
